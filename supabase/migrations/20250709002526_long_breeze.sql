/*
  # Complete Workout Tracking Database Schema

  1. New Tables
    - `profiles` - User profile information linked to auth.users
    - `exercises` - Master list of exercises (shared across users)
    - `workouts` - Individual workout sessions
    - `workout_exercises` - Exercises within a specific workout
    - `workout_sets` - Individual sets performed for each exercise

  2. Security
    - Enable RLS on all tables
    - Add comprehensive policies for user data isolation
    - Profiles can only be accessed by the owner
    - Workouts and related data isolated by user
    - Exercises are publicly readable, authenticated users can add
  ...
  4. Default Data
    - Pre-populate common exercises for immediate use
*/
